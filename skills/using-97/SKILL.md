...
4. **Before editing a file you haven't read this session, read it first — and as you read, scan for landmines** (hardcoded credentials, string-built SQL/shell, unsafe deserialization on untrusted input, swallowed exceptions). If you find one, surface it in your hand-off; do not silently rewrite outside scope. Editing without reading is the most common avoidable failure mode; reading without scanning is how landmines next to your edit ship under your name.
